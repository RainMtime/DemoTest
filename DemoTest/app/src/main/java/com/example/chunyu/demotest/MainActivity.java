...
//                        .setAction("Action", null).show();
                ...
                intent.setComponent(new ComponentName("xxxx", "xxxx"));

//                intent.putExtra("hahaha", new TestSerializableObject(1, "hahaha"));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_mediaplayer: {
                ...
                intent.putExtra(MediaPlayerActivity.VideoType, 0);
                startActivity(intent);
            }
            break;
            case R.id.nav_mediaplayer2: {
                Intent intent = new Intent(this, MediaPlayerActivity.class);
                intent.putExtra(MediaPlayerActivity.VideoType, 1);
                startActivity(intent);
            }
            break;
            case R.id.nav_videoview: {
